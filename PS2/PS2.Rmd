...
+ Two phase 1 fractions do not affect the score of main peaks of the histograms, indicating that in both situation, the expectation of spouse score does not change, unless our optimal candidate falls in phase 1. The reason could be that after getting a cutoff value, the numbers then falls to a strandard normal distribution, which is similar whenever a cutoff score is set. Thus, the "black-and-white" approach could be a better approach for this model as it gives us the difference of applying different phase 1 ratio.
